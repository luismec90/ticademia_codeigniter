...
<div id="contenedor">
    <div id="contenedor-1-2" class="container-fluid">
        <div class="row">
            <img class="col-sm-5 img-responsive" src="<?= base_url()?>/assets/img/img_presentacion.png">
            <div id="intro" class="col-sm-7 text-justify">
                <p>Bienvenido(a), TICademia es un espacio para que aprendas de una manera desafiante. Encontrarás cursos de calidad con dos componentes fundamentales. Por una parte están los materiales de estudio, generalmente videos y documentos de apoyo, los cuales son realizados por docentes expertos en las áreas de conocimiento respectivas. Por otra parte están las evaluaciones, las cuales no se limitan a simples preguntas de selección estáticas sino que en general están diseñadas para medir verdaderamente tu aprendizaje.</p>
