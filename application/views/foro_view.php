<div id="contenedor">
    <div id="contenedor-1-1" class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h1><a href="<?= base_url()?>curso/<?= $idCurso?>" class="btn btn-info" title="Ir al primer módulo"><i class="fa fa-reply"></i></a>  Foro  <small> <?= $nombre_curso ?></small> <a id="crearTema" class="btn btn-info"> Crear tema</a></h1>
            </div>
        </div>
    </div>
