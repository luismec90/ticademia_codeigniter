                        ...
                        <?php if (isset($_SESSION["nombre"])) { ?>
                            <?php if (isset($idCurso)) { ?>
                                ...
                                <?php if ($_SESSION["rol"] == 1) { ?>
                                    <li class="icono"><a id="arena" title="Duelos <button id='cerrarPopOver' type='button' class='close' aria-hidden='true'>&times;</button>" class="" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Los duelos acaban de ser habilitados, estos te permitirán batirte en conocimiento con tus demás compañeros en tiempo real, y a la vez aumentar tu puntuación. "><img src="<?= base_url() ?>assets/img/temas/default/duelo.png" height="37"></a></li>
