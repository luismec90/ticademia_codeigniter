...
class Curso extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->months = ["01" => "Ene", "02" => "Feb", "03" => "Mar", "04" => "Abr", "05" => "May", "06" => "Jun", "07" => "Jul", "08" => "Ago", "09" => "Sep", "10" => "Oct", "11" => "Nov", "12" => "Dic"];
    }
                                        ...
                                        foreach ($evaluaciones as $row) {
                                            ...
                                            <div class="boxEvaluaciones">
                                                ...
                                                <div class="opciones">
                                                    ...
                                                    <?php } else if ($row->veces_intentado > 0 && $row->veces_aprobado == 0 && $row->calificacion_minima != -1) { ?>
