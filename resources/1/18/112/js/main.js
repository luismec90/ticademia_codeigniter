...
$(function() {
    ...
    var correctAnswer2 = 2 * k;
    var correctAnswer3 = n * n - m * m;
    var correctAnswer4 = 2 * k - 2;
    var correctAnswer5 = m * n;
    var correctAnswer6 = 2 * (k - 2);
    ...
    $("#verificar").click(function() {
        ...
        if (valor1 != "" && valor2 != "" && valor3 != "" && valor4 != "" && valor5 != "" && valor6 != "") {
            ...
            if (valor1 == correctAnswer1 && valor2 == correctAnswer2 && valor3 == correctAnswer3 && valor4 == correctAnswer4 && valor5 == correctAnswer5 && valor6 == correctAnswer6) {
                calificacion = 1.0;
