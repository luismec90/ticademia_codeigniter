...
$(function() {
    ...
    var k = getRandomFrom([1/2,1,3/2,2,5/2,3,7/2]);
    r = Math.round((3+k/2)*100)/100;
    s = Math.round((4+k/2)*100)/100;

    var correctAnswer1 = 10000*(s+3.3)/(r+s);
    var correctAnswer2 = 10000*(r-3.3)/(r+s);
...
function draw(){
    $('.mvar[value=e1]').html(r);
    $('.mvar[value=e2]').html(s);
}
