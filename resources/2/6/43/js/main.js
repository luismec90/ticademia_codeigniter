...
$(function() {
    ...
    var correctAnswer = z/381.0512;
    var missConception1 = z/220;
	var missConception2 = z/vl;
    draw();
    ...
    $("#verificar").click(function() {
        ...
        if (valor != "") {
            ...
            if(Math.abs(valor-correctAnswer)<=error){
                ...
                $("#feedback").html("Calificación: <b>" + calificacion + "</b> <br> Al parecer no estás dividiendo por √3").removeClass("hide");
