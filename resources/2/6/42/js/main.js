...
$(function() {
    ...
    var correctAnswer = 48400/z;
    var missConception1 = 220/z;
	var missConception2 = vl/z;
    draw();
    ...
    $("#verificar").click(function() {
        ...
        if (valor != "") {
            ...
            if(Math.abs(valor-correctAnswer)<=error){
                ...
                $("#feedback").html("Calificación: <b>" + calificacion + "</b> <br> Al parecer no estás elevando el voltaje al cuadrado").removeClass("hide");
            }else if(Math.abs(valor-missConception2)<=error){
                calificacion = 0.5;
                feedback = "missConception2";
                $("#feedback").html("Calificación: <b>" + calificacion + "</b> <br> Al parecer no estas considerando el voltaje adecuado. La falla se encuentra ubicada en el nivel de 220kV por lo tanto el voltaje de base a seleccionar debe ser VB=220").removeClass("hide");
            }else{
                calificacion = 0.0;
