...
$(function() {
    ...
    "opacity": "0",
        ...
        startEvaluation = new Date();         $("#contenedor-frame iframe").attr("src", $(this).data("ubicacion"))
        $("#coverDisplay").css({
    "opacity": "1",
            "width": "100%",
        "height": "100%"
    ...
    success: function(data) {
        $("#modal-body-ver-valoraciones").html(data);
                ...
                $("#modalVerValoracionesMaterial").on("click", "a.pagina-valoracion-material", function() {         var idMaterial = $(this).data("id-material");
